...
const stallSchema = new Schema(
  {
    ...
    addressType: { type: String, enum: ["standalone", "building"], default: "standalone" },
    addressUnit: { type: String, default: "" },
    addressBuilding: { type: String, default: "" },
    addressBlockLot: { type: String, default: "" },
    ...
    addressLandmark: { type: String, default: "" },
